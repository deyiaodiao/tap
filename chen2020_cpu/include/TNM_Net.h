...
//constructors and destructor
	TNM_BPRLK(void) {alpha = 0.15; beta = 4.0; type = BPRLK;}
	...
	floatType  GetPower()  {return beta;}
	void SetParameters(floatType newAlpha, floatType newBeta)
	{
		alpha = newAlpha;
		beta = newBeta;
	}
...
private:
	...
	static std::atomic<int> nextPathID;
